...
function apphead()
{
	$hrow[1] = array('<tr id="row1"><td id="ag1" colspan="6">APPLICATION AND CRERTIFICATE FOR PAYMENT</td>','','','','','','','','','','','','', 'PAGE ONE OF', '{pages}', 'PAGES', '<td id="z1"></td></tr>');
	$hrow[2] = array('<tr id="row2"><td id="ab2" colspan="2">TO OWNER:</td>', '','','','','','','','<td id="jk2"></td>', '', '', '', '', '', '', '', '', '<td id="stu2" colspan="3">APPLICATION #:</td>');
	return $hrow;
}
...
function conhead($page)
{
	...
	$hrow[5] = array('<tr id="row5"><td id="a5"></td>', '<td id="b5" rowspan="3"><textarea name="sheet[project]" rows="3">{project}</textarea></td>', '<td id="c5"></td>', '<td id="d5"></td>', '<td id="e5"></td>', '<td id="fgh5" colspan="3">PERIOD TO:</td>', '<td id="i5"></td>', '<td id="j5"></td>', '<td id="k5"></td>', '<td id="l5"></td></tr>');
	$hrow[6] = array('<tr id="row6"><td id="a6"></td>',  '<td id="c6"></td>', '<td id="d6"></td>', '<td id="e6"></td>', '<td id="fgh6" colspan="3">ARCHITECT\'S PROJECT NO:</td>', '<td id="i6"></td>', '<td id="j6"></td>', '<td id="k6"></td>', '<td id="l6"></td></tr>');
	$hrow[7] = array('<tr id="row7"><td id="a7"></td>',  '<td id="c7"></td>', '<td id="d7"></td>', '<td id="e7"></td>', '<td id="fgh7" colspan="3"></td>', '', '', '<td id="i7"></td>', '<td id="j7"></td>', '<td id="k7"></td>', '<td id="l7"></td></tr>');
...
for ($page=2; $page< $pages; $page++)
{
	...
	{
		echo collet($hrow[$off], $sheet, $page, $off, $off, '1', $sheet);
	}		
