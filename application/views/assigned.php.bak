...
{
	$form = '<form method=post action=/assign/deletejobgroup/><input type=hidden name=' . $key . '[] value=' . $id . '><input type=hidden name=JobGroup[] value=' . $JobGroup . '><input type=submit value="Delete ' . $key . ' ' . $id . ' from ' . $JobGroup . '"></form>';
