...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.watch.js", "require.js", "webpro.js", "time_sheet.css"], "outOfDate":[]};
</script>
  
  <title>time_sheet</title>
  <!-- CSS -->
  <link rel="stylesheet" type="text/css" href="/css/site_global.css?crc=133766301"/>
  <link rel="stylesheet" type="text/css" href="/css/time_sheet.css?crc=4155656313" id="pagesheet"/>
    <!--HTML Widget code-->
   ...
   <div class="clearfix grpelem" id="pu5429"><!-- column -->
     ...
     <div class="clearfix" id="u5429"><!-- group -->
      ...
      <div class="clearfix grpelem" id="pu6082"><!-- group -->
       ...
       <form class="form-grp clearfix grpelem" id="widgetu6459" method="post" enctype="multipart/form-data" action="scripts/form-u6459.php" data-sizePolicy="fluidWidth" data-pintopage="page_fluidx"><!-- none box -->
        ...
        <div class="clearfix grpelem" id="ppwidgetu6743"><!-- column -->
         <div class="clearfix colelem" id="pwidgetu6743"><!-- group -->
          <div class="fld-grp clearfix grpelem" id="widgetu6743" data-required="true" data-sizePolicy="fluidWidth" data-pintopage="page_fluidx"><!-- none box -->
           <span class="fld-input NoWrap actAsDiv clearfix grpelem" id="u6745-4"><!-- content --><div id="u6745-3"><input class="wrapped-input" type="text" spellcheck="false" id="widgetu6743_input" name="custom_U6743" tabindex="1"/><label class="wrapped-input fld-prompt" id="widgetu6743_prompt" for="widgetu6743_input"><span class="actAsPara">Enter Name</span></label></div></span>
          </div>
          <div class="fld-grp clearfix grpelem" id="widgetu6460" data-required="true" data-type="email" data-sizePolicy="fluidWidth" data-pintopage="page_fluidx"><!-- none box -->
           <span class="fld-input NoWrap actAsDiv clearfix grpelem" id="u6461-4"><!-- content --><div id="u6461-3"><input class="wrapped-input" type="email" spellcheck="false" id="widgetu6460_input" name="Email" tabindex="2"/><label class="wrapped-input fld-prompt" id="widgetu6460_prompt" for="widgetu6460_input"><span class="actAsPara">Enter Email</span></label></div></span>
          </div>
          <div class="fld-grp clearfix grpelem" id="widgetu6471" data-required="false" data-sizePolicy="fluidWidth" data-pintopage="page_fluidx"><!-- none box -->
           <span class="fld-textarea actAsDiv clearfix grpelem" id="u6474-4"><!-- content --><div id="u6474-3"><textarea class="wrapped-input" id="widgetu6471_input" name="custom_U6471" tabindex="3"></textarea><label class="wrapped-input fld-prompt" id="widgetu6471_prompt" for="widgetu6471_input"><span class="actAsPara">Enter Your Message</span></label></div></span>
          </div>
         </div>
         <div class="clearfix colelem" id="pu6469-4"><!-- group -->
          <div class="clearfix grpelem" id="u6469-4"><!-- content -->
           <p>Submitting Form...</p>
          </div>
          <div class="clearfix grpelem" id="u6475-4"><!-- content -->
           <p>The server encountered an error.</p>
          </div>
          <div class="clearfix grpelem" id="u6470-4"><!-- content -->
           <p>Form received.</p>
          </div>
         </div>
        </div>
       </form>
       <div class="clearfix grpelem" id="u6512-4"><!-- content -->
        <p>UPDATE</p>
       </div>
    ...
    <div class="clearfix colelem" id="ppu5420"><!-- group -->
     <div class="clearfix grpelem" id="pu5420"><!-- column -->
      ...
      <a class="nonblock nontext Button clearfix colelem" id="buttonu5411" href="/" data-visibility="changed" style="visibility:hidden"><!-- container box --><div class="grpelem" id="u5412"><!-- state-based BG images --><img alt="Logout" src="/images/blank.gif?crc=4208392903"/><div class="fluid_height_spacer"></div></div></a>
     </div>
