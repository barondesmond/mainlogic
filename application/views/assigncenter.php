...
elseif (isset($_REQUEST['submit']) && $_REQUEST['submit'] == 'REMOVE' && !isset($_REQUEST['Assign'] && isset($employees) && isset($jobgroups) && isset($jobgroupemployees) && count($employees) > 0 && count($jobgroups) > 0 && count($jobgroupemployees)>0)
{
