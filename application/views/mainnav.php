<div class="clearfix borderbox" id="page"><!-- group -->
   <div class="clearfix grpelem" id="pu2914"><!-- column -->
	...
	<a href="<?php echo base_url() ?>/dispatch/">
       <img class="grpelem" id="u4162-4" alt="Dispatch" src="<?php echo base_url() ?>/images/u4162-4.png?crc=43866679" data-image-width="109"/></a><!-- rasterized frame -->
      </div>
     </div>
    ...
    <a class="nonblock nontext Button clearfix colelem" id="buttonu2905" href="<?php echo base_url() ?>/admin/" data-visibility="changed" style="visibility:hidden"><!-- container box --><div class="grpelem" id="u2906"><!-- state-based BG images --><img alt="Administration" src="<?php echo base_url() ?>/images/blank.gif?crc=4208392903"/><div class="fluid_height_spacer"></div></div></a>
    <div class="clip_frame colelem" id="u2899"><!-- image -->
     <img class="block" id="u2899_img" src="<?php echo base_url() ?>/images/400dpilogocropped455x100.png?crc=3930767816" alt="" data-heightwidthratio="0.22112211221122113" data-image-width="303" data-image-height="67"/>
    </div>
    <a class="nonblock nontext Button clearfix colelem" id="buttonu2907" href="<?php echo base_url() ?>/login/logout/" data-visibility="changed" style="visibility:hidden"><!-- container box --><div class="grpelem" id="u2908"><!-- state-based BG images --><img alt="Logout" src="<?php echo base_url() ?>/images/blank.gif?crc=4208392903"/><div class="fluid_height_spacer"></div></div></a>
   </div>
   <div class="clearfix" id="u2901-3"><!-- content -->
    <p>&nbsp;</p>
   </div>
   <div class="clearfix grpelem" id="pu5128-4"><!-- group -->
    <div class="clearfix grpelem" id="u5128-4">