...
{
	if (isset($_REQUEST['TimeSheet'][$id][$key]))
	{
		print_r($_REQUEST['TimeSheet'][$id][$key]);
	}
...
if (isset($_REQUEST['EmpNo']) && isset($Time[$_REQUEST['EmpNo']]))
{
	...
	echo '<tr align="center"><td><img src="/assets/images/serviq.png" width="50%"></td><td><input type=submit name="update_hours" value="Update Hours"></td><td><input type=submit name="review_timesheet", value="Review"></td><td><input type=submit name="post_timesheet" value="Post"></td></tr>';
	echo '</table>';
